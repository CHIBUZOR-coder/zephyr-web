  ...
  return useQuery({
    ...
    queryFn: async () => {
      try {
        ...
        const dummyPayer = new PublicKey("Gv9mCsh6SAt88p3D8E22TidZUpMhXFkQ1RzXh84q8k9E");
        const dummyReceiver = new PublicKey("3uYpXid8zC7GWhuFzZpYmE6rK6L7pYyR7L8z5z5z5z5z");
