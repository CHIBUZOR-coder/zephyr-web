...
import { fmt, fmtSol, fmtCompactCurrency } from '../../../../../utils/currencyHelpers'
                ...
                <div className='flex flex-col lg:flex-row items-center justify-between gap-6'>
                    ...
                    <div className='flex items-center gap-4 min-w-[280px] w-full lg:w-auto'>
                        <div className='bg-[#0a1414] rounded-xl flex justify-center items-center p-2 h-[56px] w-[56px] border border-[#1a3530]'>
                            <img 
                                src={user?.avatar || `https://api.dicebear.com/7.x/avataaars/svg?seed=${vault.fullAddress}`}
                                alt='Avatar'
                        ...
                        <div className='flex flex-col gap-1.5'>
                            ...
                            <div className='flex items-center gap-2'>
                                ...
                                <div className='flex items-center gap-1.5'>
                                    <span className='h-[10px] w-[10px] bg-center bg-cover' style={{ backgroundImage: `url("/images/time.svg")` }}></span>
                            ...
                            <div className='flex items-center gap-3 mt-1'>
                                <p className='text-[10px] font-bold text-[#009883] uppercase tracking-wider flex items-center gap-1'>
                                    <span className='h-[10px] w-[10px] bg-center bg-cover opacity-70' style={{ backgroundImage: `url("/images/totalAum.svg")` }}></span>
                        ...
                        <div className='hidden md:flex flex-col gap-1'>
                            ...
                            vault.currentPosition.state !== PositionState.Closed ? (
                                <div className='flex flex-col'>
                                    <span className='text-[14px] text-white font-[900] tracking-tight'>
                                        {(vault.currentPosition.size / LAMPORTS_PER_SOL).toFixed(2)} SOL
                                    </span>
                                    <span className='text-[9px] text-[#00ffa3] font-bold uppercase'>
                                        Entry: ${(vault.currentPosition.entryPrice / 1e6).toFixed(2)}
                                    </span>
                                </div>
                            ) : (
            ...
            <div className='bg-[#102221] border border-[#1a3530] rounded-2xl p-5 flex flex-col md:flex-row justify-between items-center gap-4'>
                <div className='flex items-center gap-4'>
                    <div className='bg-[#FE9A00]/10 p-3 rounded-xl border border-[#FE9A00]/20'>
                        <span className='bg-cover bg-center w-[24px] h-[24px] inline-block' style={{ backgroundImage: `url("/images/claim.svg")` }} />
                    </div>
                    <div>
                        ...
                        <p className='text-white text-[20px] font-[900] tracking-tight'>
                            {fmtSol(vault.availableFeesSol)} SOL <span className='text-[#546462] text-[14px] font-bold'>AVAILABLE</span>
                        </p>
                    </div>
                </div>
